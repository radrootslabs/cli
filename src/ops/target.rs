...
target_operation_contracts! {
    ...
    TransportProfileGet => (TransportProfileGetRequest, TransportProfileGetResult, "transport.profile.get"),
    TransportProfileSet => (TransportProfileSetRequest, TransportProfileSetResult, "transport.profile.set"),
    TransportStatus => (TransportStatusRequest, TransportStatusResult, "transport.status"),
    TransportOutboxStatus => (TransportOutboxStatusRequest, TransportOutboxStatusResult, "transport.outbox.status"),
    TransportOutboxPush => (TransportOutboxPushRequest, TransportOutboxPushResult, "transport.outbox.push"),
    MeshScopeGet => (MeshScopeGetRequest, MeshScopeGetResult, "mesh.scope.get"),
    MeshScopeSet => (MeshScopeSetRequest, MeshScopeSetResult, "mesh.scope.set"),
    MeshStatus => (MeshStatusRequest, MeshStatusResult, "mesh.status"),
    MeshPolicyCheck => (MeshPolicyCheckRequest, MeshPolicyCheckResult, "mesh.policy.check"),
